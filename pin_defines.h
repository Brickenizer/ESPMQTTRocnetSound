...
/* PIN References... Also defined somewhere else in the esp included code so do not unhide this section!!!...
  ...
  static const uint8_t D5   = 14;  chuff output
...
// NodeMCU D0! expects LED +resistor to +ve! DO not change this..
#define SignalLed 0
// if using as mobile (LOCO) node... node becomes a loco with servo on port D "1"  for motor control
#define _LocoDrivePort 1

// add this second Port if using PWM loco motor control assumes
// L293 inputs driven from port D(_LocoDrivePort)
// and D(_LocoPWMDirPort)
#define _LocoPWMDirPort    3
...
// D4 is used in no dac because of default i2s settings
//  (is i2s clock?) but can be used as input if you need
//  the pin in no dac..
//  but needs to be defined in order for NoDac to work
#define I2SDAC_LRC 4
// D9/rx used for both Audio types
#define I2SDAC_DIN 9
